...
CREATE TABLE `Employee` (
    ...
    `jobGrade` VARCHAR(191) NULL,
    `employmentType` VARCHAR(191) NULL DEFAULT 'Permanent / Full-Time',
    `reportingManager` VARCHAR(191) NULL,
    `workLocation` VARCHAR(191) NULL DEFAULT 'Onsite',
    `basicSalary` DOUBLE NULL,
    `hra` DOUBLE NULL,
    `specialAllowance` DOUBLE NULL,
    `conveyanceAllowance` DOUBLE NULL,
    `grossSalary` DOUBLE NULL,
    `performanceBonus` DOUBLE NULL,
